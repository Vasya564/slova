...
// Слова не повторюються між рівнями: далі — довші слова, більша сітка, більше напрямків.
export const LEVELS = [
  {
    id: 1,
    size: 9,
  ...
  },
  {
    ...
    dirs: ['E', 'S', 'SE', 'NE', 'W', 'N', 'SW', 'NW'],
    note: 'тепер слова бувають і задом наперед',
  },
]
