...
export const LEVELS = [
  ...
  },
  {
    id: 2,
    size: 11,
    words: ['васька', 'лублу', 'дєлаєм', 'полежати'],
    dirs: ['E', 'S'],
  ...
  },
  {
    id: 3,
    size: 13,
    words: ['наждачка', 'услишала', 'буквально', 'харошенький', 'лобнадоля'],
...
// Кожне слово має свій знак — його гра розсипає, коли слово знайдено.
export const EMOJI = {
  булка: '🥐',
  ксюня: '🌸',
  скучаю: '🥺',
